...
import com.example.foodizzdua.model.User;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void postDataToSQLite() {
        if (!inputValidation.isInputEditTextFilled(textInputEditTextName, textInputLayoutEmail, getString(R.string.error_message_name))) {
            return;
        }
